...
const Navbar: React.FC = () => {
  ...
  return (
    <header>
      <nav
        className={`fixed top-0 right-0 w-full z-50 transition duration-300 py-[20px] md:py-[30] ${
      ...
      >
        <div className="flex justify-between items-center container">
          ...
          <div className="flex items-center gap-x-[14px]  lg:gap-x-[20px]">
            <button className="inline-flex items-center bg-gradient-to-r from-gray-700 via-gray-500 to-white/60 text-white font-medium font-outfit py-[6px] px-[10px] lg:py-[12px] lg:px-[16px] text-[16px] lg:text-[22px] rounded-[60px] gap-1.5 border-2 border-white/34 cursor-pointer">
              Contact US
